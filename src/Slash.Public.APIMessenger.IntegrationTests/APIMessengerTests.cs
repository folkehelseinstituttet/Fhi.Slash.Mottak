...
using Slash.Public.SlashMessengerCLI;
...
namespace Slash.Public.APIMessenger.IntegrationTests;

[TestClass]
public sealed class APIMessengerTests
{
    // Client files
    ...
    private static IHost SetupHost(string baseUrl, Action<IServiceCollection>? customConfig = null, HelseIdClientDefinition? helseIdClientDefinition = null) =>
        Host.CreateDefaultBuilder()
            .ConfigureServices(services =>
            {
                customConfig?.Invoke(services);
